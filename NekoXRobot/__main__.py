...
buttons = [
    [
        InlineKeyboardButton(
            text="Add Me to your groups🎉", url="t.me/NekoXRobot?startgroup=true"
        ),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="Support🚑", url=f"https://t.me/Black_Knights_Union_Support"
        ),
        InlineKeyboardButton(text="Updates🛰️", url="https://t.me/Black_Knights_Union"),
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("NekoXRobot.modules." + module_name)
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}",
                "[❤️ 𝙈𝙮 𝙡𝙤𝙫𝙚 𝙞𝙨 𝙎𝙩𝙞𝙡𝙡 𝘼𝙡𝙞𝙫𝙚 ❤️](https://telegra.ph/file/8e4c4c8376925cab07eb1.jpg)",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
            LOGGER.warning(
    ...
    about_callback_handler = CallbackQueryHandler(
        cutiepii_callback_data, pattern=r"cutiepii_"
    )
