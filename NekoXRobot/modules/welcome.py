...
import NekoXRobot.modules.sql.welcome_sql as sql
...
from NekoXRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from NekoXRobot.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "Oof! A C Rank Hunter just joined!", reply_to_message_id=reply
                )
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "Oof! A D Rank Hunter just joined!", reply_to_message_id=reply
                )
                continue
