...
from NekoXRobot.__main__ import STATS, TOKEN, USER_INFO

import NekoXRobot.modules.sql.userinfo_sql as sql

from NekoXRobot.modules.disable import DisableAbleCommandHandler

from NekoXRobot.modules.sql.global_bans_sql import is_user_gbanned

from NekoXRobot.modules.sql.afk_sql import is_afk, check_afk_status

from NekoXRobot.modules.sql.users_sql import get_user_num_chats
...
from NekoXRobot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        ...
        "<code>Connecting to Initialising ■■■■■□</code>", parse_mode=ParseMode.HTML)
